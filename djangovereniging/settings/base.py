# Django settings for wagtaildvwagtail project.
...
# ** however this is a dvwagtail app so we're using the default settings.
# ** Don't use this key in any non-dvwagtail usage!
...
ROOT_URLCONF = 'djangovereniging.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'djangovereniging.wsgi.application'
...
EMAIL_SUBJECT_PREFIX = '[djangovereniging] '
...
WAGTAIL_SITE_NAME = 'Django vereniging'

# Override the search results template for wagtailsearch
WAGTAILSEARCH_RESULTS_TEMPLATE = 'dvwagtail/search_results.html'
