...
from dvwagtail.utils import export_event
...
class AdvertPlacement(models.Model):
    ...
    advert = models.ForeignKey('dvwagtail.Advert', related_name='+')
...
class HomePageCarouselItem(Orderable, CarouselItem):
    page = ParentalKey('dvwagtail.HomePage', related_name='carousel_items')


class HomePageRelatedLink(Orderable, RelatedLink):
    page = ParentalKey('dvwagtail.HomePage', related_name='related_links')
...
class StandardIndexPageRelatedLink(Orderable, RelatedLink):
    page = ParentalKey('dvwagtail.StandardIndexPage', related_name='related_links')
...
class StandardPageCarouselItem(Orderable, CarouselItem):
    page = ParentalKey('dvwagtail.StandardPage', related_name='carousel_items')


class StandardPageRelatedLink(Orderable, RelatedLink):
    page = ParentalKey('dvwagtail.StandardPage', related_name='related_links')
...
class BlogIndexPageRelatedLink(Orderable, RelatedLink):
    page = ParentalKey('dvwagtail.BlogIndexPage', related_name='related_links')
...
class BlogPageCarouselItem(Orderable, CarouselItem):
    page = ParentalKey('dvwagtail.BlogPage', related_name='carousel_items')


class BlogPageRelatedLink(Orderable, RelatedLink):
    page = ParentalKey('dvwagtail.BlogPage', related_name='related_links')


class BlogPageTag(TaggedItemBase):
    content_object = ParentalKey('dvwagtail.BlogPage', related_name='tagged_items')
...
class PersonPageRelatedLink(Orderable, RelatedLink):
    page = ParentalKey('dvwagtail.PersonPage', related_name='related_links')
...
class EventIndexPageRelatedLink(Orderable, RelatedLink):
    page = ParentalKey('dvwagtail.EventIndexPage', related_name='related_links')
...
class EventPageCarouselItem(Orderable, CarouselItem):
    page = ParentalKey('dvwagtail.EventPage', related_name='carousel_items')


class EventPageRelatedLink(Orderable, RelatedLink):
    page = ParentalKey('dvwagtail.EventPage', related_name='related_links')


class EventPageSpeaker(Orderable, LinkFields):
    page = ParentalKey('dvwagtail.EventPage', related_name='speakers')
