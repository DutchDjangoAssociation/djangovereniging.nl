...
@register.inclusion_tag('dvwagtail/tags/top_menu.html', takes_context=True)
...
@register.inclusion_tag('dvwagtail/tags/top_menu_children.html', takes_context=True)
...
@register.inclusion_tag('dvwagtail/tags/secondary_menu.html', takes_context=True)
...
@register.inclusion_tag(
    'dvwagtail/tags/standard_index_listing.html',
    takes_context=True
)
...
@register.inclusion_tag(
    'dvwagtail/tags/person_listing_homepage.html',
    takes_context=True
)
...
@register.inclusion_tag(
    'dvwagtail/tags/blog_listing_homepage.html',
    takes_context=True
)
...
@register.inclusion_tag(
    'dvwagtail/tags/event_listing_homepage.html',
    takes_context=True
)
...
# Advert snippets
@register.inclusion_tag('dvwagtail/tags/adverts.html', takes_context=True)
def adverts(context):
    return {
